 ...
 */
/**
 * The class CompactDisc represents a CD including its attributes.
 * 
...
public class CompactDisc {
    ...
    public void setTitle(String compactDiscTitle) {
        this.title = compactDiscTitle;
    }
    ...
    public void printCompactDisc() {
        System.out.print(title + " # CD made by " + author + ". Keywords: ");
